...
func InstrumentingMiddleware(n, s string) endpoint.Middleware {
	success, fail, duration := GetEndpointMetrics(n, s)
...
// GetEndpointMetrics metric middleware
func GetEndpointMetrics(n, s string) (success, error metrics.Counter, duration metrics.Histogram) {
